...
var webpro=function(initData,routeUrl){
    ...
    console.info("seesion对象:",initData.workerInfo);
	if(initData.workerInfo == "" || initData.workerInfo===undefined){
	 console.error("用户数据获取异常,请检查workerInfo数据的获取.");
	 alert(initData.msg);
    ...
    var $$={
		setting:{
		 ...
		 userID:initData.workerInfo.dataid,
    ...
    var _init=function(){
         ...
         * @type {string}
         */
		var userName = initData.workerInfo.name;
        ...
        $(".login-gourp .dropdown-menu .logout").click(function (){
            var url =
            $.get($$.setting.basePath/worker/logout,"",function (data){
                if (!data){
        ...
        $(".dropdown-menu .updatePwd").click(function(){
            $$.mainDialog.showDialogDiv($$.setting.basePath+$(this).attr("url")+"?userID="+$$.setting.userID, "修改密码");
        });
