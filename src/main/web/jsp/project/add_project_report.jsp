...
<form class="layui-form layui-form-pane" action="">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <select name="mission"  lay-search="" lay-filter="sele" >
                    ...
                    <c:forEach items="${project}" var="project1" varStatus="projectIndex">
                        <option value="${project1.dataid}" title="${project1.name}">${project1.name}</option>
                    </c:forEach>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea placeholder="请输入内容" name="plan" id="plan" class="layui-textarea"></textarea>
        </div>
    </div>
    <%--<div class="layui-form-item layui-form-text">
...
<script>
    ...
    layui.use(['form', 'layedit', 'laydate'], function(){
        ...
        form.on('submit(demo1)', function(data){
            ...
            var dataJson = {
                projectid:province_id,
                projectname:province_name,
                context:data.field.context,
                plan:data.field.plan,
            };
            $.ajax({
                url : '<%=basePath%>addreport',
                type : 'post',
