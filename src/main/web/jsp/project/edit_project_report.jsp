...
<input type="hidden" name="dataid" value="${report.dataid}">
    <div class="layui-form-item" id="pro1" >
        <div class="layui-inline">
            <label class="layui-form-label">选择项目</label>
            <div class="layui-input-inline">
                <select name="mission"  lay-search="" lay-filter="sele" >
                        <option value="" title="${report.projectname}" disabled>${report.projectname}</option>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea placeholder="请输入内容" name="context" id="cont" class="layui-textarea">${report.context}</textarea>
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">下周工作计划</label>
        <div class="layui-input-block">
            <textarea placeholder="请输入内容" name="plan" id="plan" class="layui-textarea">${report.plan}</textarea>
        </div>
    </div>
    <%--<div class="layui-form-item layui-form-text">
        ...
        form.on('submit(demo1)', function(data){
            ...
            $.ajax({
                ...
                success : function(data) {
                    if (data.success) {
                        layer.msg('修改项目周报成功' ,{time: 2000, icon:6});
                        $("#but").hide();
                    } else {
                        layer.msg('修改项目周报失败' ,{time: 2000, icon:5});
